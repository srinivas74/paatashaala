            ...
            <div class="row">
                ...
                <div class="col-lg-7 pl-lg-0">
                    <div class="w3l-right-info">
                        ...
                        <h3 class="title-big">We are Fair Developers,</h3>
                       ...
                       <button class="btn btn-style btn-primary mt-4" onclick="myFunction()" >Discover our services</button>
                       <script>
function myFunction() {
...
<section class="locations-1 popular" id="locations">
    ...
    if (function_exists('mysqli_fetch_array')) {
        $nquery=mysqli_query($conn, "select * from `realestate_plots_images`  where is_deleted=false LIMIT 6");
...
<div class="col-lg-3 col-md-4 col-6 mt-lg-0 pt-lg-0 mt-4 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="assets/plotimages/' . $row["image"] . '" alt="">
                            <div class="box-content">
